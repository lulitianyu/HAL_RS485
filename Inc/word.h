...
#define bitSet(value, bit)  ((value) |= (1UL << (bit))) //1ULявляется unsigned long intсо значением 1, представленным на уровне битов как:0000 0000 0000 0000 0000 0000 0000 0001
